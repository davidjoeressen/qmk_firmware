...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |      | Reset|RGBRST|      |      |      |             |      |      |      |      |      |  Del |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |QWERTY|DVORAK|Aud on|Audoff| Mac  |             | Win  |Qwerty|Dvorak|      |      |      |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |      |      |      |RGB ON| HUE+ | SAT+ | VAL+ |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |      |      |      | MODE | HUE- | SAT- | VAL- |
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      _______, QWERTY,  DVORAK,  AU_ON,   AU_OFF,  AG_NORM,                   AG_SWAP, QWERTY,  DVORAK,  _______,  _______, _______, \
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    ADJUST,  KC_ESC,  KC_LALT, KC_LGUI, KC_LSFT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RSFT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
    ),
   ...
   * | Shift|   ;  |   Q  |   J  |   K  |   X  |             |   B  |   M  |   W  |   V  |   Z  |Enter |
   * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
   * |Adjust| Esc  | Alt  | GUI  | Shift|Lower |Space | Shift|Raise | AltGr| Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_DVORAK] = LAYOUT( \
    ...
    ADJUST,  KC_ESC,  KC_LALT, KC_LGUI, KC_LSFT, LOWER,   KC_SPC,  SFTENT,  RAISE,   KC_RALT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
    ),
  ...
  [_LOWER] = LAYOUT( \
    ...
    _______, _______, _______, _______, _______, _______,                   _______, _______, KC_INS,  KC_HOME, KC_END,  _______, \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY  \
    ),
  ...
  [_RAISE] = LAYOUT( \
    ...
    _______, _______, _______, _______, _______, _______,                   _______, _______, KC_INS,  KC_PGUP, KC_PGDN, _______, \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY  \
    ),
   ...
   * | Reset|  F1  |  F2  |  F3  |  F4  |      |             |      |      |      |      |      |      |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |RGBRST|  F5  |  F6  |  F7  |  F8  | Mac  |             | Win  | Left | Down |  Up  | Right|      |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |  F9  |  F10 |  F11 |  F12 |      |             |      |      | RGB  | HUE+ | SAT+ | VAL+ |
   * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
   * |      |Qwerty|Dvorak|      |      |      |      |      |      |      | MODE | HUE- | SAT- | VAL- |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_ADJUST] =  LAYOUT( \
    RESET,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______,                   _______, _______, _______, _______, _______, _______, \
    RGBRST,  KC_F5,   KC_F6,   KC_F7,   KC_F8,   AG_NORM,                   AG_SWAP, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, \
    _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,                   _______, _______, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, \
    _______, QWERTY,  DVORAK,  _______, _______, _______, _______, _______, _______, _______, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD  \
    ),
};
